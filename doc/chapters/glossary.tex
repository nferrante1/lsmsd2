...
\begin{description}
	...
	\item[Market] A specific \textit{market cross} of a specific
		...
		market cross \exgratia{COINBASE:BTC/USD}. It's worth noting that
	...
	\item[Market cross] (or \textbf{Cross}) A couple of \textit{currencies},
		expressed as a fraction \exgratia{BTC/USD, XMR/BTC, \etc}.  The
	...
	\item[Trading day] (or \textbf{Day} or \textbf{Candle} or \textbf{Bar})
		...
		span into four values: highest price, lowest price,
		\textit{opening price}, \textit{closing price}. This makes
		reading the price action of an \textit{asset} more easy that
		following it \emph{tick-by-tick}. A trading day is also called
		\enquote{candle} or \enquote{bar} since it is often graphically
		represented as a candlestick or bar like in figure.
