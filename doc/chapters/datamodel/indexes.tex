...
collection over multiple servers, as defined in \chref{sec:distributed}.
...
configuration \idest{a configuration with the same hash}, we also define the
following:
...
queries that specifies the \code{name} or the \code{\_id} of a strategy and the
\code{hash} of the configuration.
