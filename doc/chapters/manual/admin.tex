...
You can \standout{disable} the source entirely (users will not be able to select it anymore
to run strategies); \standout{view and edit the markets} provided by the data
...
the format \code{yyyy-mm-dd hh:mm}.
